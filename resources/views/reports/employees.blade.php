<x-app-layout>
    <div class="glass-panel p-6 space-y-4">
        <div class="flex items-center space-x-3 space-x-reverse border-b border-white/5 pb-4">
            ...
            <div>
                <h2 class="text-lg font-bold text-white">تقارير أداء الموظفين والعمولات</h2>
        ...
        <div class="p-8 text-center bg-[#0a0a0a] rounded-xl border border-white/5 space-y-3">
            ...
            <p class="text-sm text-gray-400">واجهة المستخدم البرمجية لـ "تقارير أداء الموظفين والعمولات" ستكون متاحة هنا قريباً.</p>
            <div class="pt-2">
